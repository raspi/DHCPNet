...
namespace UnitTest.Option.TestEmpty
{
    ...
    public class All
    {
        ...
        [InlineData(typeof(OptionIPForwarding))]
        [InlineData(typeof(OptionNonLocalSourceRouting))]
        ...
        [InlineData(typeof(OptionMaskSupplier))]
        ...
        [InlineData(typeof(OptionTrailerEncapsulation))]
        [InlineData(typeof(OptionARPCacheTimeout))]
        [InlineData(typeof(OptionEthernetEncapsulation))]
